...
public class GetSExpressionBinaryTree {
	/*
...
(A(B(D(E(G))))(C(F)))
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub GetSExpression(Console.ReadLine()));
		String a = GetSExpressionBinaryTree.GetSExpression("(B,D) (D,E) (A,B) (C,F) (E,G) (A,C)");
		System.out.println(a); //output = (A(B(D(E(G))))(C(F)))
	}
